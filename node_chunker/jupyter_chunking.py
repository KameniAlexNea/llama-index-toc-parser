...
from .md_chunking import MarkdownTOCChunker  # Added import
...
class JupyterNotebookTOCChunker(BaseDocumentChunker):
    """
    A document chunker that converts Jupyter Notebooks to Markdown using MarkItDown and then
    ...
    def __init__(self, notebook_path: str, source_display_name: str):
        ...
        # Keep header_pattern for potential future use or legacy compatibility
    ...
    def load_document(self) -> None:
        ...
        try:
            ...
            logger.error(
                f"Error converting Jupyter notebook to Markdown using MarkItDown: {e}"
            )
            raise
        finally:
