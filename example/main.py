...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python example/main.py --source example/data/test_markdown.pdf
  python example/main.py --source example/data/test_markdown.md --format md
  python example/main.py --source https://example.com/document.html --format html
  python example/main.py --source document.docx --format docx
  python example/main.py --source notebook.ipynb --format jupyter
  python example/main.py --source example/data/test_markdown.rst --format rst
  python example/main.py --source document --format pdf
    ...
    parser.add_argument(
        "--source",
        default="example/data/test_markdown.pdf",
        required=False,
